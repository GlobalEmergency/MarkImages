 ...
 * @param seed - Seed único para la imagen
 * @param imageType - Tipo de imagen ('specific' o 'random')
 * @returns URL de la imagen
 */
function generateImageUrl(seed: string, imageType: 'specific' | 'random' = 'random'): string {
 ...
 */
function generateSeed(deaId: number, photoType: 'foto1' | 'foto2'): string {
 ...
 */
async function updateSpecificDeaImages(deaIds: number[]) {
  try {
...
export { updateDeaImages, updateSpecificDeaImages, generateImageUrl, generateSeed };
