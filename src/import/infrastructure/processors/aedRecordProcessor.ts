...
export interface AedRecordProcessorOptions {
  ...
  fileName?: string;
  /** ID de la organizaciÃ³n que importa (para asignaciÃ³n automÃ¡tica) */
  organizationId?: string;
  /** Tipo de asignaciÃ³n organizacional (default: OWNERSHIP) */
  assignmentType?: string;
  /** ID del usuario que importa (para assigned_by en la asignaciÃ³n) */
  userId?: string;
}
