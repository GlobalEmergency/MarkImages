      ...
      <div className="max-w-md w-full">
        <div className="bg-amber-50 border-2 border-amber-200 rounded-lg p-8 text-center">
          ...
          <p className="text-gray-700 mb-6">
            No perteneces a ninguna organizaciÃ³n con permisos de verificaciÃ³n de DEAs.
          </p>
          ...
          <div className="bg-white border border-amber-200 rounded-lg p-4 mb-6">
            ...
            <ul className="text-sm text-gray-700 space-y-2 text-left">
              <li className="flex items-start gap-2">
                ...
                <span>Ser miembro de una organizaciÃ³n (ej: ProtecciÃ³n Civil)</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-amber-600 mt-0.5">â€¢</span>
                <span>Tener permisos de verificaciÃ³n activados</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-amber-600 mt-0.5">â€¢</span>
                <span>Que la organizaciÃ³n tenga DEAs asignados</span>
              </li>
            </ul>
          </div>
