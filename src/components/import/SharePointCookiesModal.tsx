/**
 * Modal para solicitar cookies de SharePoint durante la importaciÃ³n
...
export default function SharePointCookiesModal({
  ...
  const handleValidate = async () => {
    ...
    try {
      ...
      if (result.valid) {
        ...
        // Esperar 1 segundo para que el usuario vea el mensaje de Ã©xito
        setTimeout(() => {
  ...
  const handleSkip = () => {
    toast.error("No se pueden importar imÃ¡genes de SharePoint sin cookies vÃ¡lidas");
    onClose();
  };
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900">
                AutenticaciÃ³n de SharePoint Requerida
              </h2>
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-blue-900 mb-2">
                  Â¿Por quÃ© necesitamos las cookies?
                </p>
                <p className="text-sm text-blue-800">
                  Tu CSV contiene enlaces a imÃ¡genes almacenadas en SharePoint. Para poder
                  descargarlas e importarlas correctamente, necesitamos las cookies de
                  autenticaciÃ³n de tu navegador.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-start space-x-3 mb-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-600">
                    Haz clic en el botÃ³n para abrir la imagen en SharePoint y obtener las cookies
                    desde allÃ­
                  </p>
                </div>
              </div>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
            <p className="text-sm font-medium text-gray-900 mb-3">
              ðŸ“‹ CÃ³mo obtener las cookies de SharePoint:
            </p>
            <ol className="list-decimal list-inside space-y-2 text-sm text-gray-700">
              ...
              <li>
                Ve a la pestaÃ±a <strong>Application</strong> â†’ <strong>Cookies</strong>
              </li>
              <li>
              ...
              <li>PÃ©galas en el campo de abajo (puedes pegar todas las cookies juntas)</li>
            </ol>
          </div>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Pega las cookies de SharePoint aquÃ­:
            </label>
            <textarea
              value={cookiesInput}
            ...
            <p className="mt-2 text-xs text-gray-500">
              ðŸ’¡ <strong>Tip:</strong> Solo se extraerÃ¡n las cookies FedAuth y rtFa, las demÃ¡s
              se ignorarÃ¡n
            </p>
          </div>
